            ...
            <div className="feedback-form-box">
                <div className="feedback-form">
                    ...
                    <div className="github-box">     {/* link to github */}
                        ...
                        <div>Our GitHub repository: <a className="color-pointer" href="https://github.com/Amir837/langleraningplatform">https://github.com/Amir837/langleraningplatform</a></div>
                    </div>
                </div>
            </div>
        </div>
